...
* @param {*} requestData - request body for update session data operation
* @param {*} sessionid  - request sessionid for session
* @param {*} callback - return response body
*/
function updateSession(sessionid, requestData, callback) {    
